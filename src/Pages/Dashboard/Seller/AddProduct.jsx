...
const AddProduct = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const checkResponse = await fetch("http://localhost/BuyBuddiesBackend/api/index.php/product");
      ...
      const response = await fetch("http://localhost/BuyBuddiesBackend/api/index.php/product", {
        method: "POST",
        headers: {
