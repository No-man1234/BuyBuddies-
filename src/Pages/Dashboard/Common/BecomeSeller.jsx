...
const BecomeSeller = () => {
  ...
  const handleBecomeSeller = async () => {
    ...
    try {
        const response = await fetch('http://localhost/BuyBuddiesBackend/api/index.php/users/seller-request', {
          method: 'POST',
          headers: {
    ...
    <div className="flex flex-col items-center justify-center p-20">
      <div className="max-w-md  p-6  rounded-lg shadow-2xl text-center">
        ...
        <button
          ...
          className="px-6 py-2 bg-orange-600 text-white rounded-md  transition-colors"
        >
          Become A Seller
        </button>
            ...
            <Dialog.Panel className="mx-auto max-w-lg rounded-lg bg-white p-6 shadow-xl">
              ...
              <div className="flex justify-end gap-4">
                <button
                  ...
                  className="px-4 py-2 bg-orange-600 text-white rounded-md  transition-colors"
                >
                  Send Request
                </button>
                <button
