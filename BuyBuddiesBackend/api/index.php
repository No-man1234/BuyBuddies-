    ...
    if ($requestMethod === 'POST') {
        ...
        if (isset($data['order_id'], $data['product_id'], $data['rating'])) {
            ...
            try {
                ...
                // Comment field can be NULL in the database
                $comment = isset($data['comment']) ? $connection->real_escape_string($data['comment']) : '';
            ...
            echo json_encode(["error" => "Invalid input: Please provide order_id, product_id, and rating."]);
        }
    }
